...
_f_define() {
    ...
    f_install_step_3() {
        local cpanm_navel_gitchain=$(f_build_cpanm_navel_gitchain navel-{base{,-definition},logger,api,base-daemon,mojolicious-plugin-{logger,swagger2-stdresponses},anyevent-{fork-rpc-serializer-sereal,pool},definition-collector,event,queue} $program_name)
